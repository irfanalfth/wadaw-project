		...
		<div class="header-body">
			<div class="row align-items-center py-4">
				...
				<div class="col-lg-6 col-5 text-right">
					<button class="btn btn-white" data-toggle="modal" data-target="#exampleModal">
						Tambah
					</button>
				</div>
			</div>
				...
				<div class="card bg-secondary border-0 mb-0">
					<form class="add-form" action="" method="post">
						<div class="form-group">
							<input type="text" class="form-control keterangan" id="keterangan" name="kebutuhan" placeholder="Kebutuhan">
						</div>
						<div class="form-group">
							<input class="form-control rupiahInput" type="text" id="rupiahInput" name="harga" placeholder="Harga">
						</div>
