				...
				<div class="card-body p-5">
					<div class="row">
						<div class="col-md-6">
							...
							<strong><?= date("d M Y", strtotime($detail['tanggal_penjualan'])); ?></strong>
						</div>
						<div class="col-md-6 text-right">
							<div class="text-muted mb-2">Status Pembayaran</div>
							<strong class="<?= $detail['status_pembayaran'] === 'LUNAS' ? 'text-success' : 'text-danger'; ?>"><?= $detail['status_pembayaran']; ?></strong>
						</div>
					</div>
					...
					<div class="mt-4">
						<div class="d-flex justify-content-end mt-3 mr-3">
							...
							<h3 class="text-primary"><?= rupiah($detail['total_penjualan']); ?></h3>
						</div>
					</div>
				</div>
			</div>
